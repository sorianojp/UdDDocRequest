...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE document_requests MODIFY COLUMN status ENUM('PENDING', 'WAITING_FOR_PAYMENT', 'VERIFYING_PAYMENT', 'PROCESSING', 'DEFICIENT', 'READY', 'CLAIMED', 'REJECTED') DEFAULT 'PENDING'");
    }
};
