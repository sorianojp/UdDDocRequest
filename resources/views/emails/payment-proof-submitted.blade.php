...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We have successfully received your payment proof for request <strong>{{ $documentRequest->reference_number }}</strong>.</p>
            
            <p>Our team will verify your payment shortly. You will be notified once the verification is complete.</p>
